...
export default function Personal() {
  return (
    <motion.main className="space-y-24" variants={VARIANTS_CONTAINER} initial="hidden" animate="visible">
      ...
      {/* Replace the original projects section with the new component */}
      <ProjectsSection />
      ...
      <motion.section variants={VARIANTS_SECTION} transition={TRANSITION_SECTION}>
        ...
        <div className="flex flex-col space-y-0">
          ...
          >
              ...
              {/* <Link  className="-mx-3 rounded-xl px-3 py-3" href="" > */}

                <div className="flex flex-col space-y-1 -mx-3 rounded-xl px-3 py-3">
                  <h4 className="font-normal dark:text-zinc-100">A Study of Merge’s Potential to Prevent the Crypto-Verse</h4>
                  <p className="text-zinc-500 dark:text-zinc-400">ICRMIR-23 Conference (2023)</p>
                </div>
              {/* </Link> */}
